...
import imageloader.shiming.com.myapplication.listeners.IOutSideTouchListener;
import imageloader.shiming.com.myapplication.model.InsertableBitmap;
import imageloader.shiming.com.myapplication.utils.FileUtils;
        ...
        if (getCurrentCropMode() != CropMode.NONE) {
            new Handler().post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (getCurrentCropMode() != CropMode.NONE) {
                        CropResultInfo resultInfo = getCropedImageInfo();
                        if (resultInfo != null) {
